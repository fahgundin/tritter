...
function LoadingHome() {
  return (
    <div className="h-screen w-screen flex flex-col bg-slate-500">
      <div className="flex flex-col min-h-screen flex-1 p-6 animate-pulse space-y-4 overflow-y-auto">
        {Array.from({ length: 5 }).map((_, i) => (
          <div
            key={i}
            className="flex flex-col items-start h-fit w-[700px] border-2 border-slate-400 rounded-2xl p-4"
          >
